...
We set our , i.e., we exam the . We will search the bug tracker forum for a specific version of a program. We will ingest how many different faults related to a specific version of the software posted in the forum.

\subsubsection{result and discuss}

Table \ref{masking effect condition} lists the bug condition of each version for each software. The column.
...
So the answer to Q1 is We can see the multiple faults is a common sense and the masking effect do exist in real software.

For each software listed in the table \ref{software description}, we searched the bug tracker system, and collect the bugs reported on the forum. Then we 
