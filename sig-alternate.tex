...
What we can do is just distinguish them, besides, we can't do anything, So the framework algorithms is shown in Algorithm 1. which is corresponding to the section "do not consider the masking effect". or a middle suan fa. 
